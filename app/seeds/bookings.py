...
def seed_bookings():
    ...
    #restaurants
    aspen_restaurant_1= Booking(name="PARC Aspen",category="Restaurants",city="Aspen",state="CO",image1="https://media-cdn.tripadvisor.com/media/photo-f/29/87/01/0b/parc-aspen-sign.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-s/28/ba/52/d9/organic-salmon.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-s/1d/8f/42/b0/fondue.jpg",price=1000)
    aspen_restaurant_2= Booking(name="Matsuhisa-Aspen",category="Restaurants",city="Aspen",state="CO",image1="https://media-cdn.tripadvisor.com/media/photo-f/1c/64/35/6b/custom-dishes.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-f/1c/64/35/5e/downstairs-bar.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-s/1c/64/35/5d/downstairs-dining-room.jpg",price=100)
    aspen_restaurant_3= Booking(name="The White House Tavern",category="Restaurants",city="Aspen",state="CO",image1="https://media-cdn.tripadvisor.com/media/photo-s/04/0c/4d/e9/hand-cut-french-fries.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-s/06/68/28/8e/the-white-house-tavern.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-f/0f/72/f2/cc/the-white-house-tavern.jpg",price=100)
    aspen_restaurant_4= Booking(name="Plato's Restaurant",category="Restaurants",city="Aspen",state="CO",image1="https://media-cdn.tripadvisor.com/media/photo-s/18/55/43/6a/plato-s-restaurant.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-f/18/54/a7/6f/plato-s-restaurant.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-f/18/55/3f/87/plato-s-restaurant.jpg",price=10)
    aspen_restaurant_5= Booking(name="Clark's Oyster Bar - Aspen",category="Restaurants",city="Aspen",state="CO",image1="https://media-cdn.tripadvisor.com/media/photo-p/28/69/bd/ba/clarks-aspen.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-s/28/69/d5/43/clarks-aspen.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-s/28/69/d4/93/clarks-aspen.jpg",price=100)
    ...
    miami_restaurants = [
        Booking(name="Mayu",category="Restaurants",city="Miami",state="FL",image1="https://media-cdn.tripadvisor.com/media/photo-p/2a/34/27/57/12.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-f/2a/34/27/5d/7.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-l/2a/34/27/59/5.jpg",price=1000),
        Booking(name="Sala'o Cuban Restaurant & Bar",category="Restaurants",city="Miami",state="FL",image1="https://media-cdn.tripadvisor.com/media/photo-s/2a/cf/4a/7b/delicious-cuban-food.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-f/2a/c8/77/e0/chuleta-de-cerdo.jpg",image3="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/26/99/10/64/pesca-malecon-la-mulata.jpg",price=10),
        Booking(name="CRAFT South Beach - Espanola Way",category="Restaurants",city="Miami",state="FL",image1="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2a/8b/e2/62/a-bit-of-out-best-sellers.jpg",image2="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/28/0d/09/83/some-of-our-pizzas.jpg",image3="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/28/0d/02/4d/potatoe-rosti.jpg",price=100),
        Booking(name="Osteria Positano",category="Restaurants",city="Miami",state="FL",image1="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/29/fc/d9/b5/italian-restaurant-in.jpg",image2="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2a/89/a0/84/italian-restaurant-in.jpg",image3="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2a/89/a0/81/italian-restaurant-in.jpg?w=1200&h=800&s=1",price=100),
        Booking(name="On Ocean 7 Cafe",category="Restaurants",city="Miami",state="FL",image1="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/f9/b9/10/on-ocean-7-cafe.jpg",image2="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/f9/ba/5b/on-ocean-7-cafe.jpg",image3="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/06/f9/b8/bf/on-ocean-7-cafe.jpg?w=1200&h=800&s=1",price=10)
    ]
    ...
    napa_restaurants = [
        Booking(name="Bistro Don Giovanni",category="Restaurants",city="Napa",state="CA",image1="https://media-cdn.tripadvisor.com/media/photo-s/04/65/56/b6/bistro-don-giovanni.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-s/12/a6/b9/fb/bistro-don-giovanni.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-l/1d/9a/7e/c0/caption.jpg",price=100),
        Booking(name="Wit & Wisdom",category="Restaurants",city="Napa",state="CA",image1="https://media-cdn.tripadvisor.com/media/photo-s/1b/fa/45/c1/grab-a-seat-at-the-bar.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-f/1b/fa/45/90/crispy-berkshire-porchetta.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-f/1b/fa/48/fb/fresh-local-fruits-and.jpg",price=100),
        Booking(name="LaSalette Restaurant",category="Restaurants",city="Napa",state="CA",image1="https://media-cdn.tripadvisor.com/media/photo-s/09/c2/e5/fd/lasalette-restaurant.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-l/1b/f5/d0/4c/img-20200906-200010-largejpg.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-f/1c/da/16/f0/20210412-125746-largejpg.jpg",price=1000),
        Booking(name="the girl & the fig",category="Restaurants",city="Napa",state="CA",image1="https://media-cdn.tripadvisor.com/media/photo-s/1d/29/e0/c5/roasted-half-chicken.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-l/1d/b4/b5/e8/local-king-salmon-pepperonata.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-l/1d/86/b5/10/gulf-shrimp-corn-sweet.jpg",price=10),
        Booking(name="Ciccio",category="Restaurants",city="Napa",state="CA",image1="https://media-cdn.tripadvisor.com/media/photo-s/05/71/16/b4/ciccio.jpg",image2="https://media-cdn.tripadvisor.com/media/photo-o/03/42/08/4a/all-decked-out-for-the.jpg",image3="https://media-cdn.tripadvisor.com/media/photo-l/16/e6/38/10/photo0jpg.jpg",price=100)
    ]
